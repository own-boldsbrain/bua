...
@activity.defn
async def iniciar_homologacao_activity(
    projeto_id: str, distribuidora_codigo: str, projeto_data: Dict[str, Any]
) -> Dict[str, Any]:
    """
    ...
    """
    logger.info(
        f"Iniciando homologação para projeto {projeto_id} na distribuidora {distribuidora_codigo}"
    )
...
@activity.defn
async def consultar_status_homologacao_activity(
    projeto_id: str, distribuidora_codigo: str
) -> Dict[str, Any]:
    """
...
@activity.defn
async def submeter_documentos_activity(
    projeto_id: str, distribuidora_codigo: str, documentos: List[Dict[str, str]]
) -> Dict[str, Any]:
    """
...
class HomologacaoWorkflow:
    ...
    async def run(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "steps": steps,
            "result": {"inicio": resultado_inicio, "status": resultado_consulta},
        }
